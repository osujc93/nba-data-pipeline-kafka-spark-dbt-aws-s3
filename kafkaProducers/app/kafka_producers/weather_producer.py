...
# Process weather data and prepare it for sending to Kafka
def process_weather_data(data):
    ...
    if 'weather' in data['gameData']:
        try:
            ...
            weather_info['month'] = month
            weather_info['day'] = day
            weather_info['game_time'] = game_time
            weather_info.columns = [f"weather_{col}" if col not in ['game_id', 'season', 'day', 'month', 'game_time'] else col for col in weather_info.columns]
            return weather_info
        except Exception as e:
...
# Stream weather data for a range of game numbers
